...
في لوحة السياق بـ Glasshouse، **تظهر Tools قبل System Prompt والMessages**. يعكس هذا الترتيب بدقة **تسلسل بادئة KV-Cache في Anthropic API**.
...
في لوحة Context في Glasshouse، تُعرض أدوات MCP إلى جانب الأدوات المدمجة في منطقة Tools، مما يوفر رؤية واضحة لحجم مخطط كل أداة ومساهمتها في بادئة التخزين المؤقت.
