...
Glasshouse'ın Bağlam panelinde **Tools, System Prompt ve Messages'tan önce görünür**. Bu sıralama, **Anthropic API'nin KV-Cache önek sırasını** tam olarak yansıtır.
...
Glasshouse'ın Context panelinde, MCP araçları yerleşik araçlarla birlikte Tools alanında görüntülenir ve her aracın Şema boyutunu ve önbellek ön ekine katkısını net bir şekilde gösterir.
