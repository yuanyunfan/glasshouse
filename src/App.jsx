      ...
      <ConfigProvider theme={this.themeConfig}>
        ...
        <Layout className={styles.layout} ref={this._layoutRef} onDragOver={this._onDragOver} onDragLeave={this._onDragLeave} onDrop={this._onDrop}>
          ...
          <div className={styles.footer}>
            ...
            <div className={styles.footerRight}>
              <a href="https://github.com/yuanyunfan/glasshouse" target="_blank" rel="noopener noreferrer" className={styles.footerLink}>
        ...
        >
          <div style={{ lineHeight: 1.8 }}>
            ...
            <code style={{ display: 'block', background: 'var(--bg-code)', padding: '8px 12px', borderRadius: 6, fontSize: 13 }}>npm update -g @yuanyunfan/glasshouse</code>
            ...
            <div style={{ marginTop: 16, textAlign: 'right' }}>
              <Button type="primary" href="https://github.com/yuanyunfan/glasshouse/releases" target="_blank" rel="noopener noreferrer">
